<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoyaltorPackagingRatesAudit.aspx.cs" Inherits="WARS.Audit.RoyaltorPackagingRatesAudit" MasterPageFile="~/MasterPage.Master"
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="ContentPlaceHolderBody">
    <script type="text/javascript">
        ...
        function RedirectToMaintScreen(royaltorId) {
            window.location = "../Contract/RoyContractPkgRates.aspx?RoyaltorId=" + royaltorId + "&isNewRoyaltor=N";
        }
            ...
            <table id="tblMain" width="100%">
                ...
                <tr>
                    ...
                    <td align="right" colspan="2">
                        <asp:Button ID="btnPackagingRates" runat="server" Text="Packaging Rates" CssClass="ButtonStyle"
                            Width="98%" UseSubmitBehavior="false" OnClick="btnPackagingRates_Click" TabIndex="104" onkeydown="OnTabPress();" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td class="table_header_with_border" colspan="9" runat="server" id="tdDataHeader">Packaging Rates</td>
                </tr>
                <tr>
                    <td></td>
                                                ...
                                                <asp:Panel ID="PnlRoyaltorRatesAudit" runat="server" ScrollBars="Auto" Width="100%">
                                                    <asp:GridView ID="gvRoyaltorRatesAudit" runat="server" AutoGenerateColumns="False" Width="98%" AlternatingRowStyle-BackColor="#E3EFFF"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="16%" ItemStyle-CssClass="gridItemStyle_Left_Align_No_Padding" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Catalogue No." SortExpression="catno">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCatno" runat="server" Text='<%# Bind("catno") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="16%" ItemStyle-CssClass="gridItemStyle_Left_Align_No_Padding" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Configuration Code" SortExpression="config">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblConfigCode" runat="server" Text='<%# Bind("config") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="12%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Packaging Rate" SortExpression="rate_value">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRoyaltyPkgRate" runat="server" Text='<%# Bind("rate_value","{0:0.###}") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="8%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Updated by" SortExpression="user_code">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUpdatedby" runat="server" Text='<%# Bind("user_code") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="12%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Updated on" SortExpression="last_modified">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUpdatedon" runat="server" Text='<%# Bind("last_modified") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="8%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Deleted by" SortExpression="deleted_by">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDeletedby" runat="server" Text='<%# Bind("deleted_by") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="12%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Deleted on" SortExpression="deleted_on">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HiddenField ID="hdnClrSeller" runat="server" Value='<%# Bind("clr_seller") %>'></asp:HiddenField>
                                                                    <asp:HiddenField ID="hdnClrCatno" runat="server" Value='<%# Bind("clr_catno") %>'></asp:HiddenField>
                                                                    <asp:HiddenField ID="hdnClrConfig" runat="server" Value='<%# Bind("clr_config") %>'></asp:HiddenField>
                                                                    <asp:HiddenField ID="hdnClrPkgRate" runat="server" Value='<%# Bind("clr_rate_value") %>'></asp:HiddenField>
