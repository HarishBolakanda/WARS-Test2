<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoyaltorSubsidiaryRatesAudit.aspx.cs" Inherits="WARS.Audit.RoyaltorSubsidiaryRatesAudit" MasterPageFile="~/MasterPage.Master"
    Title="WARS - Royaltor Subsidiary Rates Audit" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="ContentPlaceHolderBody">
    <script type="text/javascript">
        ...
        function SetGrdPnlHeightOnLoad() {
            ...
            document.getElementById("<%=PnlSubsidiaryRatesAudit.ClientID %>").style.height = gridPanelHeight + "px";
        ...
        function RedirectToMaintScreen(royaltorId) {
            window.location = "../Contract/RoyContractSubRates.aspx?RoyaltorId=" + royaltorId + "&isNewRoyaltor=N";
        }
            ...
            <table id="tblMain" width="100%">
                ...
                <tr>
                    ...
                    <td align="right" colspan="2">
                        <asp:Button ID="btnSubsidiaryRates" runat="server" Text="Subsidiary Rates" CssClass="ButtonStyle"
                            Width="98%" UseSubmitBehavior="false" OnClick="btnSubsidiaryRates_Click" TabIndex="104" onkeydown="OnTabPress();" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td class="table_header_with_border" colspan="9" runat="server" id="tdDataHeader">Subsidiary Royalty Rates</td>
                </tr>
                <tr>
                    <td></td>
                                ...
                                <td colspan="3">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr runat="server" id="trRoyAudit">
                                            <td>
                                                <asp:Panel ID="PnlSubsidiaryRatesAudit" runat="server" ScrollBars="Auto" Width="100%">
                                                    <asp:GridView ID="gvSubsidiaryRatesAudit" runat="server" AutoGenerateColumns="False" Width="98%" AlternatingRowStyle-BackColor="#E3EFFF"
                                                        ...
                                                        EmptyDataText="No data found." OnRowDataBound="gvRoyaltorRatesAudit_RowDataBound" AllowSorting="true" OnSorting="gvSubsidiaryRatesAudit_Sorting" HeaderStyle-CssClass="FixedHeader">
                                                        <Columns>
                                                            <asp:TemplateField ItemStyle-Width="8%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Option Period" SortExpression="option_period_code">
                                                                <ItemTemplate>
                                                                    <asp:HiddenField ID="hdnRateId" runat="server" Value='<%# Bind("subsid_rate_id") %>' />
                                                                    <asp:Label ID="lblOptionPeriodCode" runat="server" Text='<%# Bind("option_period_code") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="16%" ItemStyle-CssClass="gridItemStyle_Left_Align_No_Padding" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Territory" SortExpression="seller">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblTerritory" runat="server" Text='<%# Bind("seller") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="16%" ItemStyle-CssClass="gridItemStyle_Left_Align_No_Padding" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Sales Type" SortExpression="price">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="6%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Revenue Rate" SortExpression="revenue_rate">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRevenueRate" runat="server" Text='<%# Bind("rate_value","{0:0.####}") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="6%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Royalty Rate" SortExpression="roy_rate">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="6%" ItemStyle-CssClass="gridItemStyle_Left_Align_No_Padding" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Updated by" SortExpression="user_code">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUpdatedby" runat="server" Text='<%# Bind("user_code") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="10%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Updated on" SortExpression="last_modified">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUpdatedon" runat="server" Text='<%# Bind("last_modified") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="6%" ItemStyle-CssClass="gridItemStyle_Left_Align_No_Padding" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Deleted by" SortExpression="deleted_by">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDeletedby" runat="server" Text='<%# Bind("deleted_by") %>' CssClass="identifierLable"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Width="10%" ItemStyle-CssClass="gridItemStyle_Center_Align" HeaderStyle-CssClass="gridHeaderStyle_1row" HeaderText="Deleted on" SortExpression="deleted_on">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HiddenField ID="hdnClrOptionCode" runat="server" Value='<%# Bind("clr_option_period_code") %>' />
