    ...
    public class TransactionRetrievalDAL : ITransactionRetrievalDAL
    {
        ...
        public DataSet GetSearchFilterData(out Int32 iErrorId)
        {
            ...
            try
            {
                ...
                OracleParameter curRoyaltorOptionPrd = new OracleParameter();
                OracleParameter curCatArtist = new OracleParameter();
                OracleParameter curCatNumber = new OracleParameter();
                OracleParameter curProjectNumber = new OracleParameter();
                orlDA = new OracleDataAdapter();

                orlCmd = new OracleCommand("pkg_trans_retrieval_screen.p_get_filter_list", orlConn);
                orlCmd.CommandType = System.Data.CommandType.StoredProcedure;

                curRoyaltorOptionPrd.OracleDbType = OracleDbType.RefCursor;
                curRoyaltorOptionPrd.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(curRoyaltorOptionPrd);

                curCatArtist.OracleDbType = OracleDbType.RefCursor;
                curCatArtist.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(curCatArtist);

                curCatNumber.OracleDbType = OracleDbType.RefCursor;
                curCatNumber.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(curCatNumber);

                curProjectNumber.OracleDbType = OracleDbType.RefCursor;
                curProjectNumber.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(curProjectNumber);
