    ...
    public class AdHocStatementDAL : IAdHocStatementDAL
    {
        ...
        public void SaveStatement(string stmtDescription, string stmtStartDate, string stmtEndDate, Array roysToAdd, string loggedUser, out string stmtTypeCode, out Int32 iErrorId)
        {
            try
            {
                ...
                OpenConnection(out iErrorId, out sErrorMsg);
                ErrorId = new OracleParameter();
                OracleParameter pStmtDescription = new OracleParameter();
                ...
                pStmtDescription.OracleDbType = OracleDbType.Varchar2;
                pStmtDescription.Direction = ParameterDirection.Input;
                pStmtDescription.Value = stmtDescription;
                orlCmd.Parameters.Add(pStmtDescription);
