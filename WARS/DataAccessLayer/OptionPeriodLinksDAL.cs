    ...
    public class OptionPeriodLinksDAL : IOptionPeriodLinksDAL
    {
        ...
        public DataSet GetRoyaltorsArtistsList(out Int32 iErrorId)
        {
            ...
            try
            {
                ...
                OracleParameter cur_royaltors_list = new OracleParameter();
                OracleParameter cur_artists_list = new OracleParameter();

                orlCmd = new OracleCommand("pkg_maint_option_period_links.p_get_royaltors_artists", orlConn);
                orlCmd.CommandType = System.Data.CommandType.StoredProcedure;

                cur_royaltors_list.OracleDbType = OracleDbType.RefCursor;
                cur_royaltors_list.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(cur_royaltors_list);

                cur_artists_list.OracleDbType = OracleDbType.RefCursor;
                cur_artists_list.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(cur_artists_list);
