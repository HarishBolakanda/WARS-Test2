...
namespace WARS.BusinessLayer
{
    public class RoyaltorReservesBL : IRoyaltorReservesBL
    {
        ...
        {
            return RoyaltorReservesDAL.GetRoyaltors(out iErrorId);
        }
        ...
        public DataSet InsertRoyaltorRsvData(Int32 royaltorId, Int32 reservePeriodId, Int32 lqdInterval, double rsvAmount, out Int32 iErrorId)
        {
            return RoyaltorReservesDAL.InsertRoyaltorRsvData(royaltorId, reservePeriodId, lqdInterval, rsvAmount, out iErrorId);
        }
        ...
        public DataSet InsertRoyaltorLqdData(Int32 royaltorId, Int32 reservePeriodId, Int32 lqdPeriodId,Int32 lqdInterval, double lqdAmount, out Int32 iErrorId)        
        {
            return RoyaltorReservesDAL.InsertRoyaltorLqdData(royaltorId, reservePeriodId, lqdPeriodId, lqdInterval, lqdAmount, out iErrorId);            
        }
