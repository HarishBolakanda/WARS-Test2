...
namespace WARS.BusinessLayer
{
    public class UserAccountMaintBL:IUserAccountMaintBL
    {
        ...
        public DataSet AddUserAccount(string userName, string userCode, string userAccId, string respCode, string roleId, string isActive, string userFilter, string loggedUser,
                               out Int32 iErrorId)
        {
            return UserAccountMaintDAL.AddUserAccount(userName, userCode, userAccId, respCode, roleId, isActive, userFilter, loggedUser, out iErrorId);
        }
                                    ...
                                    string roleId, string isActive, string userFilter, string loggedUser, out Int32 iErrorId)
        {
            return UserAccountMaintDAL.UpdateUserAccount(userAccId, userCode, respCode, userName, userCodeNew, userAccIdNew, respCodeNew,
                                                        roleId, isActive, userFilter, loggedUser, out iErrorId);
        }

        public void UpdateRespChanges(string respToReplace, string newResp, out Int32 iErrorId)
        {
            UserAccountMaintDAL.UpdateRespChanges(respToReplace, newResp, out iErrorId);
        }
