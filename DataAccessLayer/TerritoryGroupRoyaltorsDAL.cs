...
{
    public class TerritoryGroupRoyaltorsDAL : ITerritoryGroupRoyaltorsDAL
    {
        ...
        public DataSet GetRoyaltorList(string territoryGroupCode, out Int32 iErrorId)
        {
            ...
            try
            {
                ...
                orlCmd = new OracleCommand("pkg_territory_group_royaltors.p_get_royaltor_list", orlConn);
                ...
                curRoyaltorList.OracleDbType = OracleDbType.RefCursor;
                curRoyaltorList.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(curRoyaltorList);
