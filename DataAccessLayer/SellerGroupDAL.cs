    ...
    public class SellerGroupDAL : ISellerGroupDAL
    {
        ...
        public DataSet AddTerritoryToGroup(string territoryGroupCode, Array territorycode, string userCode, out Int32 iErrorId)
        {
            ...
            try
            {
                ...
                OracleParameter curGrpInData = new OracleParameter();
                OracleParameter curGrpOutData = new OracleParameter();
                //OracleParameter cur_seller_locations_in = new OracleParameter();
                //OracleParameter cur_seller_locations_out = new OracleParameter();
                ...
                inGroupCode.Value = territoryGroupCode;
                ...
                inTerritoryCode.CollectionType = OracleCollectionType.PLSQLAssociativeArray;
                if (territorycode.Length == 0)
                {
                    inTerritoryCode.Size = 0;
                    inTerritoryCode.Value = new OracleDecimal[1] { OracleDecimal.Null };
                }
                else
                {
                    inTerritoryCode.Size = territorycode.Length;
                ...
                curGrpInData.OracleDbType = OracleDbType.RefCursor;
                curGrpInData.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(curGrpInData);

                curGrpOutData.OracleDbType = OracleDbType.RefCursor;
                curGrpOutData.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(curGrpOutData);
        ...
        public DataSet InsertTerritoryGroup(string territoryGroupCode, string territoryGroupName, string userCode, out Int32 iErrorId)
        {
            ...
            try
            {
                ...
                OracleParameter inUserCode = new OracleParameter();
                OracleParameter cuGrpInData = new OracleParameter();
                OracleParameter curGrpOutData = new OracleParameter();
                //OracleParameter cur_seller_locations_in = new OracleParameter();
                //OracleParameter cur_seller_locations_out = new OracleParameter();
                ...
                inGroupName.Value = territoryGroupName;
                ...
                cuGrpInData.OracleDbType = OracleDbType.RefCursor;
                cuGrpInData.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(cuGrpInData);
