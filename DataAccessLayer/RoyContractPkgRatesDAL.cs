...
{
    public class RoyContractPkgRatesDAL : IRoyContractPkgRatesDAL
    {
        ...
        public DataSet GetPkgRatesData(string royaltorId, string optionPeriod, string userRoleId, out string royaltor, out Int32 iErrorId)
        {
            ...
            try
            {
                ...
                OracleParameter pPkgRatesData = new OracleParameter();
                ...
                orlCmd = new OracleCommand("pkg_roy_contract_package_rates.p_get_contract_pkg_rates", orlConn);
                ...
                pPkgRatesData.OracleDbType = OracleDbType.RefCursor;
                pPkgRatesData.Direction = System.Data.ParameterDirection.Output;
                orlCmd.Parameters.Add(pPkgRatesData);
        ...
        public DataSet SavePkgRates(string royaltorId, string optionPeriod, string loggedUser, string userRoleId, Array addUpdateList, Array deleteList, out string royaltor, out string invalidCatno, out Int32 iErrorId)
        {
            ...
            try
            {
                ...
                orlCmd = new OracleCommand("pkg_roy_contract_package_rates.p_save_contract_pkg_rates", orlConn);
                orlCmd.CommandType = System.Data.CommandType.StoredProcedure;
