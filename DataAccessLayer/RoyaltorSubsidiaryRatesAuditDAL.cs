...
{
    public class RoyaltorSubsidiaryRatesAuditDAL : IRoyaltorSubsidiaryRatesAuditDAL
    {
        ...
        public DataSet GetSubsidiaryRatesAuditData(string royaltorId, string fromDate, string toDate, string userRoleId, out Int32 iErrorId)
        {
            ...
            try
            {
                ...
                orlCmd = new OracleCommand("pkg_roy_subsidiary_rates_audit.p_get_subsidiary_rates_audit", orlConn);
