...
namespace WARS.IBusiness
{
    ...
    {        
        ...
        DataSet InsertRoyaltorLqdData(Int32 royaltorId, Int32 reservePeriodId, Int32 lqdPeriodId,Int32 lqdInterval, double lqdAmount, string userCode, out Int32 iErrorId);        
