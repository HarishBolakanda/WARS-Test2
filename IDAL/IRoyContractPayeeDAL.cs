...
namespace WARS.IDAL
{
    public interface IRoyContractPayeeDAL
    {
        ...
        void AddInterestedParty(string partyType, string partyName, string address1, string address2, string address3, string address4, string postCode, string email, string VATNum, string taxType,
