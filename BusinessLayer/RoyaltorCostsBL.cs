...
namespace WARS.BusinessLayer
{
    public class RoyaltorCostsBL : IRoyaltorCostsBL
    {
        ...
        {
            return RoyaltorCostsDAL.SaveCost(royaltor, statementPeriod, fromDate, toDate, userCode, costList, out iErrorId);
        }
        ...
        {
            return RoyaltorCostsDAL.UpdateCost(journalEntryId, royaltor, statementPeriod, fromDate, toDate, description, date, amount, suppName, projCode, invNum, isDeleted, out iErrorId);
        }
