...
namespace WARS.BusinessLayer
{
    public class RoyaltorGroupingsBL : IRoyaltorGroupingsBL
    {
        ...
        {
            return RoyaltorGroupingsDAL.AddRoyaltorToGroup(grpTypeCode, grpId, searchedRoyaltorId, royaltorId, userCode, out iErrorId);
        }
        ...
        {
            return RoyaltorGroupingsDAL.RemoveRoyaltorFromGroup(grpTypeCode, grpId, searchedRoyaltorId, royaltorId, userCode, out iErrorId);
        }
